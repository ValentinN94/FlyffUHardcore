...
#     loop_time = time()
#     print(counter)
#     cv.imwrite('result' + str(counter) +'.jpg', wincap.screenshot)
#     counter += 1
#     if points:
#        print('Pass')

#Testing of death matching
#######################################################################################################################
# import os
# from time import time
# from windowcapture import WindowCapture
...
# os.chdir(main_directory)
# os.chdir('FlyffUHardcore')
# image_path = os.path.join(os.getcwd(), 'images', 'death', 'resurrection.PNG')
# print(f"Full image path: {image_path}")
#
# wincap = WindowCapture('FlyffHarcore')
# new_char = Vision(image_path)
...
os.chdir(main_directory)
os.chdir('FlyffUHardcore')
image_path = os.path.join(os.getcwd(), 'images', 'buff_pang', 'buff_pang_dialog.PNG')
print(f"Full image path: {image_path}")
